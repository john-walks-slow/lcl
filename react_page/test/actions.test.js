...
describe('actions', () => {
  ...
  it('should create an action to change grid dimensions', () => {
    ...
    expect(actions.changeDimensions('columns', 1)).toEqual(
      expectedAction
    )
  })
  ...
  it('should create an action to set a drawing', () => {
    ...
    expect(actions.setDrawing([], [], 10, 2, 2)).toEqual(
      expectedAction
    )
  })
  ...
  it('should create an action to send a notification', () => {
    ...
    expect(actions.sendNotification('some message')).toEqual(
      expectedAction
    )
  })
  ...
  it('should create an action to change the hover cell position', () => {
    ...
    expect(actions.changeHoveredCell({ x: 2, y: 3 })).toEqual(
      expectedAction
    )
  })
})
