      ...
      os.forEach((o) => {
        switch (o.type) {
          case "object":
            ...
            break;
          case "item":
            o.instance = this.scene.itemGroup.create(o.x, o.y, configurations.ITEM_LIST[o.itemId].name).setDisplaySize(configurations.OBJECT_W.S, configurations.OBJECT_W.S);
